...
def parse_args():
    ...
    parser_arg.add_argument('--batch_size', type=int, default=128, help='batch size')
    ...
    parser_arg.add_argument('--m1', type=int, default=1500, help='m1 of fine-grained components number')
    parser_arg.add_argument('--m2', type=int, default=1000, help='m2 of coarse-grained components number')
