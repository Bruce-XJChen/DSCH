...
# saving path
data_path = '/apdcephfs/share_1367250/qinghonglin/hash_datasets/flickr25k/FLICKR25K.mat'
save_path = '/apdcephfs/private_qinghonglin/hash_DSCH/checkpoints/output/flickr25k/' + version
logfile_dir = '/apdcephfs/private_qinghonglin/hash_DSCH/checkpoints/log/flickr25k/'
logfile_name = version + '.log'
mkdir(save_path)

logger = setup_logger(logfile_name, logs_dir=logfile_dir, also_stdout=False)
logger.info('dataset: flickr25k')
